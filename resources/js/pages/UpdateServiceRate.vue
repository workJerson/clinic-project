...
export default {
  ...
  mounted () {
      this.fetchServiceRate();
      this.fetchServices();
      this.fetchHmo();
  },
  methods: {
    fetchServiceRate() {
      this.$axios.get(`/api/service-rates/${this.$route.params.id}`)
      .then((response) => {
          this.hmo = response.data.hmo.id;
          this.service = response.data.service.id;
          this.rate = response.data.total_rate;
      }).catch((error) => {
          console.log(error)
      })
    },
    ...
    submitServiceRate() {
      this.$axios.patch(
          `api/service-rates/${this.$route.params.id}`,{
            h_m_o_id: this.hmo,
